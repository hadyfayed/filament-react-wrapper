...
export abstract class BaseStateManager implements IStateManager {
  ...
  protected getNestedValue<T = any>(obj: Record<string, any>, path: string): T | undefined {
  ...
  protected setNestedValue(obj: Record<string, any>, path: string, value: any): Record<string, any> {
...
export class PersistentStateManager extends StandardStateManager {
  constructor(private persistence: IStatePersistence, private persistenceKey: string = 'app-state') {
    super();
